  ...
  construct: function(self, options) {
      ...
      self.load = function (req, widgets, next) {
          ...
          widgets.forEach((widget) => {
              ...
              widget.countdownPeriod = sitesConfig && siteConfig.ideas && siteConfig.ideas.automaticallyUpdateStatus && siteConfig.ideas.automaticallyUpdateStatus.afterXDays || 0;
