              ...
              choices: [
                {
                  value: 'checkbox',
                  label: 'Checkbox',
                  showFields: ['descriptionText', 'fieldKey', 'fieldRequired', 'fieldOptions', 'notExtraDataKey']
                },
                {
                  value: 'agreed-checkbox',
                  label: 'Checkbox privacy',
                  showFields: ['agreedLabel']
                },
                {
                  value: 'choicesSlider',
                ...
                },
                {
                  value: 'date',
                  label: "Date",
                  showFields: ['descriptionText', 'fieldKey', 'fieldRequired']
                },
                {
                  value: 'fileUpload',
                  label: "File upload",
                ...
                },
                {
                  value: 'hidden',
                  label: "Hidden",
                  showFields: ['descriptionText', 'fieldKey', 'fieldValue', 'notExtraDataKey']
                },
                {
                  value: 'image',
                  label: "Image",
                  showFields: ['descriptionText']
                },
                {
                  value: 'imageChoice',
                  label: "Image choices",
                  showFields: ['descriptionText', 'fieldKey', 'fieldRequired', 'fieldImages']
                },
                {
                  value: 'info',
                  label: "Information",
                  showFields: ['descriptionText', 'descriptionImage', 'imageAltText', 'descriptionAccordeon']
                },
                {
                  value: 'map',
                  label: "Map",
                  ...
                  },
                {
                  ...
                  },
                  {
                      value: 'text',
                      label: "Text",
                      showFields: ['descriptionText', 'fieldKey', 'fieldRequired', 'fieldMin', 'fieldMax', 'notExtraDataKey']
                  },
                  {
                      value: 'textarea',
                      label: "Textarea",
                  ...
                  },
                  {
                      value: 'vimeo',
                      label: "Vimeo",
                      showFields: ['descriptionText', 'fieldRequired']
                  },
                ]
            },
            {
